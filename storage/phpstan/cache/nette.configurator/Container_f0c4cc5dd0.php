...
// source: phar:///Applications/MAMP/htdocs/muscle-xpert/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
...
class Container_f0c4cc5dd0 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f0c4cc5dd0 $container)
			{
	...
	public function createServiceContainer(): Container_f0c4cc5dd0
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/Applications/MAMP/htdocs/muscle-xpert/vendor/bin/phpstan',
				'LINES' => '12',
				'COLUMNS' => '175',
				'SHELL_VERBOSITY' => '0',
			],
