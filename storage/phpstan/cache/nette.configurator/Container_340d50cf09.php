...
class Container_340d50cf09 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_340d50cf09 $container)
			{
	...
	public function createServiceContainer(): Container_340d50cf09
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/usr/local/Cellar/php@8.3/8.3.20/bin/php',
