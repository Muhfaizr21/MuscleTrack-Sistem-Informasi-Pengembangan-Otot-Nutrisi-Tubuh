...
class Container_e84c45e9d4 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['0236', '0711', '0712', '0714']],
		...
		'PHPStan\Collectors\Collector' => [1 => ['0688', '0689', '0690', '0691', '0692', '0693', '0694', '0695', '0696']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['0710', '0713', '0715', '0716']],
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e84c45e9d4 $container)
			{
	...
	public function createServiceContainer(): Container_e84c45e9d4
	{
		return $this;
	}
