        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
                        ...
                        @if($user->fitnessProfile)
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-3 md:mb-4">
                                <div class="flex items-center gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-emerald-500/5 border border-emerald-500/10">
                                    <div class="w-6 h-6 md:w-8 md:h-8 bg-emerald-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                @switch($user->fitnessProfile->activity_level)
                                    @case('light')
                                        <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-blue-500/5 border border-blue-500/10">
                                            <div class="w-5 h-5 md:w-6 md:h-6 bg-blue-500/20 rounded-lg flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    @case('moderate')
                                        <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-amber-500/5 border border-amber-500/10">
                                            <div class="w-5 h-5 md:w-6 md:h-6 bg-amber-500/20 rounded-lg flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    @case('heavy')
                                        <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-red-500/5 border border-red-500/10">
                                            <div class="w-5 h-5 md:w-6 md:h-6 bg-red-500/20 rounded-lg flex items-center justify-center mt-0.5 flex-shrink-0">
                                ...
                                @if($user->fitnessProfile->daily_calorie_target)
                                    @if($user->fitnessProfile->daily_calorie_target > 2500)
                                        <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-purple-500/5 border border-purple-500/10">
                                            <div class="w-5 h-5 md:w-6 md:h-6 bg-purple-500/20 rounded-lg flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    @elseif($user->fitnessProfile->daily_calorie_target < 1800)
                                        <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-green-500/5 border border-green-500/10">
                                            <div class="w-5 h-5 md:w-6 md:h-6 bg-green-500/20 rounded-lg flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    @else
                                        <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg md:rounded-xl bg-emerald-500/5 border border-emerald-500/10">
                                            <div class="w-5 h-5 md:w-6 md:h-6 bg-emerald-500/20 rounded-lg flex items-center justify-center mt-0.5 flex-shrink-0">
                                                <span class="text-emerald-400 text-xs md:text-sm">•</span>
                                            </div>
                                            <div class="min-w-0">
            ...
            @if(!$user->fitnessProfile)
                <div class="glass-dark rounded-2xl md:rounded-3xl p-4 md:p-6 border border-amber-500/20 shadow-lg md:shadow-xl shadow-amber-500/10 mb-6 md:mb-8">
                    <div class="flex flex-col sm:flex-row items-start gap-3 md:gap-4">
                        <div class="w-10 h-10 md:w-12 md:h-12 bg-amber-500/20 rounded-lg md:rounded-xl flex items-center justify-center border border-amber-500/30 flex-shrink-0">
            ...
            {{-- ✅ Notifikasi Sukses --}}
            @if(session('success'))
                <div class="glass rounded-xl md:rounded-2xl p-3 md:p-4 mb-4 md:mb-6 border border-emerald-500/30 bg-emerald-500/10">
