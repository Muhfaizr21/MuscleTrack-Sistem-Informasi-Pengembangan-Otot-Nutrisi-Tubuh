    ...
    <div class="bg-black/70 backdrop-blur-lg border border-gray-700/50 shadow-sm sm:rounded-lg p-6 max-w-xl mx-auto">
        ...
        <form action="{{ route('user.nutrition.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="meal_name" value="{{ old('meal_name') }}" class="mt-1 block w-full bg-gray-800 border-gray-700 rounded-md shadow-sm text-white
            ...
            <div>
                ...
                <input type="number" step="1" name="calories" value="{{ old('calories') }}" class="mt-1 block w-full bg-gray-800 border-gray-700 rounded-md shadow-sm text-white
                               focus:border-amber-400 focus:ring focus:ring-amber-400 focus:ring-opacity-50" required>
            ...
            <div>
                ...
                <input type="number" step="0.1" name="protein" value="{{ old('protein') }}" class="mt-1 block w-full bg-gray-800 border-gray-700 rounded-md shadow-sm text-white
                               focus:border-amber-400 focus:ring focus:ring-amber-400 focus:ring-opacity-50" required>
            ...
            <div>
                ...
                <input type="number" step="0.1" name="carbs" value="{{ old('carbs') }}" class="mt-1 block w-full bg-gray-800 border-gray-700 rounded-md shadow-sm text-white
                               focus:border-amber-400 focus:ring focus:ring-amber-400 focus:ring-opacity-50" required>
            ...
            <div>
                ...
                <input type="number" step="0.1" name="fat" value="{{ old('fat') }}" class="mt-1 block w-full bg-gray-800 border-gray-700 rounded-md shadow-sm text-white
                               focus:border-amber-400 focus:ring focus:ring-amber-400 focus:ring-opacity-50" required>
