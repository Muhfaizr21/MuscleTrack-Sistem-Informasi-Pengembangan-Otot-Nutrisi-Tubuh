...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <!-- Back Button -->
        <a href="{{ route('trainer.communities.index') }}" class="btn-back self-start">
        ...
        <div class="admin-controls">
            <a href="{{ route('trainer.communities.edit', $community->slug) }}" class="btn-admin">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('trainer.communities.members', $community->slug) }}" class="btn-admin">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <div class="ml-0 sm:ml-32">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                    ...
                    <div class="flex items-center justify-end sm:justify-start">
                        @if($isMember)
                        <form action="{{ route('trainer.communities.leave', $community->slug) }}" method="POST">
                            @csrf
                            <button type="submit" 
                        ...
                        @else
                        <form action="{{ route('trainer.communities.join', $community->slug) }}" method="POST">
                            @csrf
    ...
    <div class="create-post-card">
        ...
        <form action="{{ route('trainer.communities.posts.store', $community->slug) }}" method="POST" enctype="multipart/form-data">
            @csrf
        ...
        @if($posts->count() > 0)
            ...
            <div class="post-card">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <!-- Admin Post Controls -->
                    @if($isMember && ($userRole === 'admin' || $userRole === 'moderator'))
                    <form action="{{ route('trainer.communities.posts.destroy', $post->id) }}" method="POST" class="ml-auto">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
                ...
                <div id="comments-{{ $post->id }}" class="comment-section hidden">
                    <!-- Add Comment Form -->
                    <form action="{{ route('trainer.communities.comments.store', $post->id) }}" method="POST" class="mb-4">
                        @csrf
                    ...
                    <div class="space-y-3">
                        ...
                        @include('trainer.communities.partials.comment', [
                            'comment' => $comment, 
...
<script>
    ...
    document.addEventListener('click', async (e) => {
        if (e.target.closest('.like-btn')) {
            ...
            try {
                const url = isLiked ? 
                    `/trainer/communities/posts/${postId}/unlike` : 
                    `/trainer/communities/posts/${postId}/like`;
    ...
    async function likeComment(commentId) {
        ...
        try {
            const url = isLiked ? 
                `/trainer/communities/comments/${commentId}/unlike` : 
                `/trainer/communities/comments/${commentId}/like`;
