...
@section('title', 'Create Nutrition Plan')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-black text-white">
                            Create <span class="text-gradient">Nutrition Plan</span>
                        </h1>
                        <p class="text-emerald-400/80 text-lg mt-2">Add new nutrition plan for {{ $member->name }}</p>
                    </div>
                </div>
            ...
            <form action="{{ route('trainer.programs.nutrition.store', $member->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="calories" value="{{ old('calories') }}" required min="0"
                                   placeholder="0"
                                   class="w-full px-4 py-3 bg-white border border-emerald-500/20 rounded-xl text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="protein" value="{{ old('protein') }}" required min="0" step="0.1"
                                   placeholder="0.0"
                                   class="w-full px-4 py-3 bg-white border border-emerald-500/20 rounded-xl text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="carbs" value="{{ old('carbs') }}" required min="0" step="0.1"
                                   placeholder="0.0"
                                   class="w-full px-4 py-3 bg-white border border-emerald-500/20 rounded-xl text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300">
                            <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm">g</span>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="fat" value="{{ old('fat') }}" required min="0" step="0.1"
                                   placeholder="0.0"
                                   class="w-full px-4 py-3 bg-white border border-emerald-500/20 rounded-xl text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300">
                            <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm">g</span>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="water_intake" value="{{ old('water_intake') }}" min="0" step="0.1"
                                   placeholder="0.0"
                                   class="w-full px-4 py-3 bg-white border border-emerald-500/20 rounded-xl text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="hydrogen_level" value="{{ old('hydrogen_level') }}" min="0" step="0.1"
                                   placeholder="0.0"
                                   class="w-full px-4 py-3 bg-white border border-emerald-500/20 rounded-xl text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300">
                ...
                <div>
                    ...
                    <select name="target_fitness"
                        ...
                        @foreach($targetFitnessOptions as $option)
                            <option value="{{ $option }}" {{ old('target_fitness') == $option ? 'selected' : '' }}>
                                {{ $option }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="glass-dark rounded-3xl p-6 border border-blue-500/20 shadow-xl shadow-blue-500/10 mt-8">
            <h3 class="text-lg font-black text-white mb-4 flex items-center gap-2">
                <span class="text-blue-400">💡 Quick Tips</span>
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div class="flex items-start gap-3">
                    <div class="w-6 h-6 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span class="text-blue-400 text-xs">1</span>
                    </div>
                    <div>
                        <p class="text-white font-medium mb-1">Meal Naming</p>
                        <p class="text-blue-400/70">Use descriptive names like "Grilled Salmon with Quinoa"</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-6 h-6 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                        <p class="text-white font-medium mb-1">Nutrition Balance</p>
                        <p class="text-blue-400/70">Aim for balanced macros based on member's goals</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-6 h-6 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                        <p class="text-white font-medium mb-1">Daily Distribution</p>
                        <p class="text-blue-400/70">Spread calories evenly throughout the day</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-6 h-6 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                        <p class="text-white font-medium mb-1">Goal Alignment</p>
                        <p class="text-blue-400/70">Match nutrition plans with member's fitness objectives</p>
                    </div>
                </div>
            </div>
        </div>
