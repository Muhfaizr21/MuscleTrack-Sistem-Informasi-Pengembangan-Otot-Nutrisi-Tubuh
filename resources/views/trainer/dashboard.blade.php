...
@section('content')
    ...
    <div class="mb-8 md:mb-12 relative z-10">
        <div class="flex items-center gap-3 mb-4">
            <div class="w-2 h-8 bg-gradient-to-b from-emerald-400 to-emerald-600 rounded-full shadow-emerald-500/30 shadow-lg"></div>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 relative overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 w-24 h-24 bg-emerald-500/5 rounded-full translate-y-12 -translate-x-12"></div>
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative z-10">
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/20">
    ...
    <div class="mb-8 md:mb-12 relative z-10">
        <h2 class="text-xl font-bold text-white mb-4 md:mb-6 flex items-center gap-3">
            <div class="w-1 h-6 bg-gradient-to-b from-emerald-400 to-emerald-600 rounded-full shadow-emerald-500/30 shadow-sm"></div>
            Overview Statistics
        </h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {{-- Total Members Card --}}
            <div
                class="glass-card rounded-2xl p-5 md:p-6 group hover:border-emerald-400/60 hover:shadow-xl hover:shadow-emerald-500/20 hover:-translate-y-1 smooth-transition relative overflow-hidden">
                <div class="absolute top-0 right-0 w-20 h-20 bg-emerald-500/5 rounded-full -translate-y-10 translate-x-10 group-hover:scale-150 smooth-transition"></div>
                <div class="flex items-center justify-between relative z-10">
                    <div class="flex-1">
                        <p class="text-gray-300 text-sm font-medium mb-2">Total Members</p>
                    ...
                    <div
                        class="w-12 h-12 md:w-14 md:h-14 bg-emerald-500/10 rounded-xl flex items-center justify-center group-hover:scale-110 smooth-transition border border-emerald-500/20">
            ...
            <div
                class="glass-card rounded-2xl p-5 md:p-6 group hover:border-blue-400/60 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-1 smooth-transition relative overflow-hidden">
                <div class="absolute top-0 right-0 w-20 h-20 bg-blue-500/5 rounded-full -translate-y-10 translate-x-10 group-hover:scale-150 smooth-transition"></div>
                <div class="flex items-center justify-between relative z-10">
                    <div class="flex-1">
                        <p class="text-gray-300 text-sm font-medium mb-2">Active Programs</p>
                        <p class="text-white text-2xl md:text-3xl font-bold">
                    ...
                    <div
                        class="w-12 h-12 md:w-14 md:h-14 bg-blue-500/10 rounded-xl flex items-center justify-center group-hover:scale-110 smooth-transition border border-blue-500/20">
            ...
            {{-- Messages Card --}}
            <div
                class="glass-card rounded-2xl p-5 md:p-6 group hover:border-purple-400/60 hover:shadow-xl hover:shadow-purple-500/20 hover:-translate-y-1 smooth-transition relative overflow-hidden">
                <div class="absolute top-0 right-0 w-20 h-20 bg-purple-500/5 rounded-full -translate-y-10 translate-x-10 group-hover:scale-150 smooth-transition"></div>
                <div class="flex items-center justify-between relative z-10">
                    <div class="flex-1">
                        <p class="text-gray-300 text-sm font-medium mb-2">Unread Messages</p>
                        <p class="text-white text-2xl md:text-3xl font-bold">
                    ...
                    <div
                        class="w-12 h-12 md:w-14 md:h-14 bg-purple-500/10 rounded-xl flex items-center justify-center group-hover:scale-110 smooth-transition border border-purple-500/20">
            ...
            {{-- Notifications Card --}}
            <div
                class="glass-card rounded-2xl p-5 md:p-6 group hover:border-yellow-400/60 hover:shadow-xl hover:shadow-yellow-500/20 hover:-translate-y-1 smooth-transition relative overflow-hidden">
                <div class="absolute top-0 right-0 w-20 h-20 bg-yellow-500/5 rounded-full -translate-y-10 translate-x-10 group-hover:scale-150 smooth-transition"></div>
                <div class="flex items-center justify-between relative z-10">
                    <div class="flex-1">
                        <p class="text-gray-300 text-sm font-medium mb-2">Notifications</p>
                        <p class="text-white text-2xl md:text-3xl font-bold">
                    ...
                    <div
                        class="w-12 h-12 md:w-14 md:h-14 bg-yellow-500/10 rounded-xl flex items-center justify-center group-hover:scale-110 smooth-transition border border-yellow-500/20">
                        <svg class="w-6 h-6 md:w-7 md:h-7 text-yellow-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9">
                            </path>
    ...
    <div class="mb-8 md:mb-12 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 md:gap-6">
            ...
            <a href="{{ route('trainer.members.index') }}"
                class="group glass-card rounded-2xl p-6 smooth-transition hover:border-emerald-400/60 hover:shadow-xl hover:shadow-emerald-500/20 hover:-translate-y-2 relative overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 smooth-transition border border-emerald-500/20 shadow-emerald-500/10 shadow-md">
            ...
            <a href="{{ route('trainer.communication.chat.index') }}"
                class="group glass-card rounded-2xl p-6 smooth-transition hover:border-blue-400/60 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-2 relative overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-blue-500/20 to-blue-600/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 smooth-transition border border-blue-500/20 shadow-blue-500/10 shadow-md">
            ...
            <a href="{{ route('trainer.nutrition.dashboard') }}"
                class="group glass-card rounded-2xl p-6 smooth-transition hover:border-purple-400/60 hover:shadow-xl hover:shadow-purple-500/20 hover:-translate-y-2 relative overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-purple-500/20 to-purple-600/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 smooth-transition border border-purple-500/20 shadow-purple-500/10 shadow-md">
            ...
            @php
                $firstMember = \App\Models\User::where('trainer_id', Auth::id())->where('role', 'user')->first();
            @endphp

            @if($firstMember)
                <a href="{{ route('trainer.programs.nutrition.index', ['memberId' => $firstMember->id]) }}"
                    class="group glass-card rounded-2xl p-6 smooth-transition hover:border-pink-400/60 hover:shadow-xl hover:shadow-pink-500/20 hover:-translate-y-2 relative overflow-hidden">
                    <div
                    ...
                    <div class="relative z-10 flex items-start gap-4">
                        <div
                            class="w-14 h-14 bg-gradient-to-br from-pink-500/20 to-pink-600/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 smooth-transition border border-pink-500/20 shadow-pink-500/10 shadow-md">
            ...
            <a href="{{ route('trainer.quality.verification.status') }}"
                class="group glass-card rounded-2xl p-6 smooth-transition hover:border-yellow-400/60 hover:shadow-xl hover:shadow-yellow-500/20 hover:-translate-y-2 relative overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 smooth-transition border border-yellow-500/20 shadow-yellow-500/10 shadow-md">
            ...
            <a href="{{ route('trainer.communication.notifications.index') }}"
                class="group glass-card rounded-2xl p-6 smooth-transition hover:border-red-400/60 hover:shadow-xl hover:shadow-red-500/20 hover:-translate-y-2 relative overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-red-500/20 to-red-600/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 smooth-transition border border-red-500/20 shadow-red-500/10 shadow-md relative">
                        ...
                        @if($unreadNotificationsCount > 0)
                            <span
                                class="absolute -top-1 -right-1 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center text-white text-xs font-bold animate-pulse border-2 border-gray-900 shadow-lg">
    ...
    <div class="mt-10 md:mt-12 glass-card rounded-2xl p-6 md:p-8 text-center relative overflow-hidden">
        ...
        <div class="flex flex-col items-center gap-4">
            <div class="flex items-center justify-center gap-3 text-gray-300">
                <div
                    class="w-10 h-10 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 rounded-xl flex items-center justify-center shadow-emerald-500/10 shadow-md">
...
@section('styles')
    <style>
        ...
        .bg-gradient {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #041f1a 0%, #061613 50%, #0a0f0e 100%);
            z-index: 1;
        }
        ...
        .bg-blob {
            position: absolute;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(16, 185, 129, 0.05) 0%, rgba(5, 150, 105, 0.02) 50%, transparent 70%);
            filter: blur(60px);
            z-index: 3;
        }
