<x-layouts.admin>
    <x-slot name="title">
        Buat Program <span class="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">Nutrisi Baru</span>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="target_fitness" id="target_fitness" required
                                ...
                                <option value="cutting" {{ old('target_fitness') == 'cutting' ? 'selected' : '' }}>🔥 Cutting (Defisit Kalori)</option>
                                <option value="maintenance" {{ old('target_fitness') == 'maintenance' ? 'selected' : '' }}>⚖️ Maintenance</option>
                                <option value="bulking" {{ old('target_fitness') == 'bulking' ? 'selected' : '' }}>💪 Bulking (Surplus Kalori)</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="lunch" {{ old('type') == 'lunch' ? 'selected' : '' }}>☀️ Makan Siang</option>
