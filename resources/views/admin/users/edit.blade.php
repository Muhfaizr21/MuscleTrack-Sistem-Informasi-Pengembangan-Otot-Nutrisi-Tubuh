<x-layouts.admin>
    <x-slot name="title">
        Edit <span class="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">User</span>
    </x-slot>
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="p-6 border-b border-slate-700/50">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400 mt-1">Memperbarui data user {{ $user->name }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 space-y-8">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-2">Biarkan kosong jika tidak ingin mengubah password</p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('admin.users.show', $user) }}"
                           class="px-6 py-3 rounded-xl border border-blue-500/50 text-blue-400 hover:text-white hover:bg-blue-500/10 transition-all duration-300 flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
