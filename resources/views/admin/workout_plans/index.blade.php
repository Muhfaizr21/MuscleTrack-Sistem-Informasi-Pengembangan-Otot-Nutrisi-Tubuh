<x-layouts.admin>
    ...
    <style>
        ...
        #workout-plans-container .text-slate-300 {
            color: #cbd5e1 !important;
        }

        #workout-plans-container .text-slate-400 {
            color: #94a3b8 !important;
        }

        #workout-plans-container .text-slate-500 {
    ...
    <div id="workout-plans-container"
        class="force-bg-slate-800 force-border-slate-700 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                <thead class="force-bg-slate-700">
                    <tr>
                        <th
                            class="px-6 py-4 text-left text-xs font-semibold force-text-gray-400 uppercase tracking-wider">
                            Program Latihan</th>
                        <th
                            class="px-6 py-4 text-left text-xs font-semibold force-text-gray-400 uppercase tracking-wider">
                            Target</th>
                        ...
                        <th
                            ...
                            Status</th>
                        <th
                            class="px-6 py-4 text-right text-xs font-semibold force-text-gray-400 uppercase tracking-wider">
                            Aksi</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr class="border-t force-border-slate-700 hover:force-bg-slate-700 transition-colors duration-300">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-12 h-12 bg-gradient-to-br from-green-500/20 to-emerald-600/20 rounded-xl flex items-center justify-center">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="text-xs force-text-gray-500 mt-1">
                                            {{ $plan->workout_exercises_count ?? 0 }} latihan
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full badge-blue capitalize">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm force-text-gray-300">
                                <div class="flex items-center gap-2">
                                    <svg class="w-4 h-4 force-text-gray-500" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a href="{{ route('admin.workout-plans.show', $plan) }}"
                                        class="px-3 py-1.5 bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 border border-blue-500/30 rounded-lg transition-all duration-300 hover:scale-105 flex items-center gap-1.5"
                                        title="Lihat Detail">
                                    ...
                                    <a href="{{ route('admin.workout-plans.edit', $plan) }}"
                                        class="px-3 py-1.5 bg-yellow-500/10 text-yellow-400 hover:bg-yellow-500/20 border border-yellow-500/30 rounded-lg transition-all duration-300 hover:scale-105 flex items-center gap-1.5"
                                        title="Edit">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('admin.workout-plans.destroy', $plan) }}" method="POST"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            onclick="return confirm('Yakin ingin menghapus program \'{{ $plan->title }}\'?')"
                                            class="px-3 py-1.5 bg-red-500/10 text-red-400 hover:bg-red-500/20 border border-red-500/30 rounded-lg transition-all duration-300 hover:scale-105 flex items-center gap-1.5"
                                            title="Hapus">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center force-text-gray-500">
                                    <svg class="w-20 h-20 mb-4 opacity-30" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
