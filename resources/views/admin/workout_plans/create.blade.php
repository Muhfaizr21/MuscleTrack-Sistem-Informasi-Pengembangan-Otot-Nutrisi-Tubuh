<x-layouts.admin>
    <x-slot name="title">
        Buat Program <span class="text-amber-400">Latihan Baru</span>
    </x-slot>
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="difficulty_level" id="difficulty_level" value="{{ old('difficulty_level') }}"
                               class="mt-1 block w-full bg-gray-800 border-gray-700 rounded-md shadow-sm text-white focus:border-amber-400 focus:ring-amber-400"
