            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 bg-slate-800/50 hover:bg-green-500/10 rounded-xl flex items-center justify-center border border-slate-700/50 hover:border-green-500/30 transition-all duration-300 group">
                            <svg class="w-5 h-5 text-slate-400 group-hover:text-green-400" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-slate-700/30 py-8">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                ...
                <div class="flex items-center space-x-6 text-sm">
                    <span class="text-slate-500">Built with</span>
