<x-layouts.landing>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-8">
                ...
                <div class="z-10 lg:col-span-7">
                    ...
                    <p class="mt-8 text-lg text-gray-300 max-w-lg">
                        Selamat datang di MuscleXpert. Kami adalah sistem analisis Anda, yang mengubah data tubuh menjadi rencana presisi untuk hasil yang nyata.
                    </p>
                    <div class="mt-12 flex items-center gap-4">
                        <a href="{{ route('register') }}" class="px-8 py-3 rounded-md text-base font-bold text-black bg-amber-400 hover:bg-amber-300 transition-all shadow-lg shadow-amber-500/20">
                            Mulai Rencana Anda
                        </a>
                        <a href="#features" class="px-8 py-3 rounded-md text-base font-medium text-white bg-gray-800/50 hover:bg-gray-700 transition-all">
                            Pelajari Metodenya
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5 h-64 lg:h-auto lg:absolute lg:right-0 lg:top-0 lg:w-1/2 lg:h-full">
                    <div class="w-full h-full bg-gray-800 opacity-20 lg:opacity-100" style="background-image: url('https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=2670&auto=format&fit=crop'); background-size: cover; background-position: center; mix-blend-mode: lighten; opacity: 0.5;">
                        </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-left max-w-2xl">
                ...
                <p class="mt-6 text-lg text-gray-400">
                    Sistem kami dibangun di atas tiga pilar: analisis data presisi, rencana yang dapat dieksekusi, dan pelacakan progres yang terbukti.
                </p>
            </div>
            ...
            <div class="mt-20 grid md:grid-cols-3 gap-12">
                ...
                <div class="relative">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="mt-4 text-gray-400">
                            Sistem kami menghitung BMR, TDEE, dan kebutuhan makro Anda secara otomatis. Tidak ada lagi tebakan.
                        </p>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="mt-4 text-gray-400">
                            Lacak setiap aspek kemajuan Anda, dari `Body Metrics` hingga `Progress Logs` harian.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="" class="py-20 sm:py-32 bg-black z-10 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative lg:-mt-16 lg:ml-8 z-10">
                            <div class="p-8 bg-black/80 backdrop-blur-lg border border-gray-700/50 rounded-lg shadow-xl">
                                <span class="text-sm font-medium text-amber-400 uppercase tracking-widest">Nutrisi</span>
                                ...
                                <p class="mt-4 text-gray-400">
                                    Memahami asupan protein sangat krusial. Sistem kami membantu melacak ini, tapi inilah ilmu di balik mengapa Anda membutuhkannya...
                                </p>
                                <a href="{{ route('articles.index') }}" class="mt-6 inline-block font-bold text-amber-400 hover:text-amber-300 transition-colors">
                ...
                <div class="lg:col-span-5">
                    ...
                    <div class="mt-8 space-y-10">
                        ...
                        <div class="group relative">
                            <div class="absolute -left-4 -top-2 font-serif text-7xl font-bold text-gray-800/50 z-0 opacity-50">01</div>
                        ...
                        <div class="group relative">
                            <div class="absolute -left-4 -top-2 font-serif text-7xl font-bold text-gray-800/50 z-0 opacity-50">02</div>
                            <div class="relative z-10 pl-8 border-l-2 border-amber-500/30 group-hover:border-amber-400 transition-all duration-300">
                                <span class="text-sm text-gray-500 uppercase tracking-widest">Gaya Hidup</span>
                                <a href="#" class="block mt-1">
                                    <h5 class_ ="font-serif text-xl font-bold text-white group-hover:text-amber-400 transition-all duration-300">
