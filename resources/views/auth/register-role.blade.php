        ...
        <div class="w-full sm:max-w-md">
            ...
            <div class="p-8 bg-black/70 backdrop-blur-lg border border-gray-700/50 shadow-md sm:rounded-lg">
                ...
                <form method="POST"
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-amber-400 mb-2">Saya ingin mendaftar sebagai:</label>
                    ...
                    <div class="relative w-full flex items-center justify-center my-6">
                        ...
                        <div class="relative px-4 text-gray-400 text-sm" style="background-color: rgba(26, 26, 26, 0.8);">
                            ATAU
                        </div>
                    </div>
